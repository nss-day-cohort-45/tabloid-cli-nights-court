    ...
    internal class BlogDetailManager : IUserInterfaceManager
    {
        ...
        private void ViewBlogPosts()
        {
            List<Post> posts = _postRepository.GetByBlog(_blogId);
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("This blog doesn't have any saved posts.");
                    Console.WriteLine();
                    Console.WriteLine("Press enter to continue.");
                    Console.ReadLine();
                    Console.Clear();
        ...
        private void AddTag()
        {
            ...
            try
            {
                ...
                Console.WriteLine($"Successfully added ({tag.Name}) tag to {blog.Title}");
                Console.WriteLine();
                Console.WriteLine("Press enter to continue.");
                Console.ReadLine();
                Console.Clear();
        ...
        private void RemoveTag()
        {
            ...
            try
            {
                ...
                Console.WriteLine($"Successfully removed ({tag.Name}) tag from {blog.Title}");
                Console.WriteLine();
                Console.WriteLine("Press enter to continue.");
                Console.ReadLine();
                Console.Clear();
